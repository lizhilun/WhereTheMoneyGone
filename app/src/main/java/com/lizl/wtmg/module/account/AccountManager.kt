...
object AccountManager
{
    ...
    val expenditureTypeList = listOf(AppConstant.EXPENDITURE_TYPE_MEALS, AppConstant.EXPENDITURE_TYPE_SNACKS,
            ...
            AppConstant.EXPENDITURE_TYPE_RENT, AppConstant.EXPENDITURE_TYPE_GAME,
            AppConstant.EXPENDITURE_TYPE_HOUSING_LOAN, AppConstant.EXPENDITURE_TYPE_LIVE_PAYMENT,
            AppConstant.EXPENDITURE_TYPE_BROKERAGE, AppConstant.EXPENDITURE_TYPE_TRAFFIC,
            AppConstant.EXPENDITURE_TYPE_MEMBERSHIP, AppConstant.EXPENDITURE_TYPE_DIGITAL,
            AppConstant.EXPENDITURE_TYPE_TRANSFER_OUT, AppConstant.EXPENDITURE_TYPE_ENTERTAINMENT,
            AppConstant.EXPENDITURE_TYPE_RED_ENVELOPES, AppConstant.EXPENDITURE_TYPE_MEDICAL_CARE,
            AppConstant.EXPENDITURE_TYPE_HOTEL, AppConstant.EXPENDITURE_TYPE_HOUSEHOLD_GOODS)
